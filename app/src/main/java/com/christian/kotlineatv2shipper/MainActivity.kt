...
class MainActivity : AppCompatActivity() {
    ...
    private var shipperRef: DatabaseReference?=null
    ...
    private fun init(){
        ...
        shipperRef = FirebaseDatabase.getInstance().getReference(Common.SHIPPER_REF)
    ...
    private fun checkShipperUserFromFirebase(user: FirebaseUser) {
        dialog!!.show()
        shipperRef!!.child(user!!.uid)
    ...
    private fun showRegisterDialog(user: FirebaseUser) {
        ...
        builder.setPositiveButton("REGISTRAR"){dialogInterface,_->
            ...
            dialog!!.show()
            shipperRef!!.child(shipperUserModel.uid!!).setValue(shipperUserModel)
    ...
    private fun goToHomeActivity(user:ShipperUserModel) {
        Common.currentShipperUser = user
